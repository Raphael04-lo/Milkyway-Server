...
COPY public.planet (p_id, name, description, history, yearly_vistors, radius, distance, price_per_day, weather, short_decription, img) FROM stdin;
...
SELECT pg_catalog.setval('public.article_a_id_seq', 2, true);
